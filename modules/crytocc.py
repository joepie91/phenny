...
def welcome(phenny, input):
	phenny.say("%s: welcome to %s! Please be aware that this channel is publicly logged, and make sure to read the rules in the channel topic. You may hide messages from the public logs by prefixing them with [off]." % (input.group(1), sender))
